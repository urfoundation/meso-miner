...
```bash
curl -fSsL https://raw.githubusercontent.com/urfoundation/meso-miner/refs/heads/main/scripts/Provider_Uninstall_Linux.sh | sh
```
...
```bash
curl -fSsL https://raw.githubusercontent.com/urfoundation/meso-miner/refs/heads/main/scripts/Provider_Install_Mac.sh | sh
```
...
```powershell
powershell -c "irm https://raw.githubusercontent.com/urfoundation/meso-miner/refs/heads/main/scripts/Provider_Install_Win32.ps1 | iex"
```

Uninstall via PowerShell (no admin required):

```powershell
powershell -c "irm https://raw.githubusercontent.com/urfoundation/meso-miner/refs/heads/main/scripts/Provider_Uninstall_Win32.ps1 | iex"
```
